...
class BuildTimerStatus(StatusLabel):
    ...
    def _subscribe_status(self):
        round_idx_key: str = GameModel.round_idx.key  # type: ignore
    ...
    def _start_countdown(self):
        # Use metadata instead of SG.state.until_tick because tick_end update happens after round increment
